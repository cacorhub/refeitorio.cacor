    ...
    <?php
     ...
     <!-- Conteudo da página principal... -->
      <div class='container'>
          <div class='row'>
            <div class='col s12'>
              <h3>Refeições Solicitadas (Janta)</h3>
              <h4>
              ...
              <?php
               ...
               //chamando a funcao que verificarReserva a tabela ficha
                ...
                $hora_atual = date("H:i");
                if (($hora_atual >= "12:30") and ($hora_atual < "22:00")) {
                    $estado = 'Aberto';
                ...
                echo "<a class='btn' href='lista_alunos_adm_fichas.php?data_cardapio=$hoje&tipo=D&ordem=nome&refeicao=J'>Ver lista de alunos que reservaram</a>";

                verificarReserva($conexao, $id, $hoje, "J");
              ...
              <?php
                  ...
                  //Habilita botões para reserva de ficha de 16:00hs até as 22hs.
